...
import {
     HiOutlineHome, HiOutlineDocumentText, HiOutlineChartBarSquare,
     HiOutlineUsers, HiOutlineArrowRightOnRectangle, HiOutlineBars3,
     HiOutlineXMark, HiShieldCheck,
} from 'react-icons/hi2'

const navItems = [
     { path: '/admin', icon: HiOutlineHome, label: 'Dashboard', end: true },
     { path: '/admin/tests', icon: HiOutlineDocumentText, label: 'Tests' },
     { path: '/admin/results', icon: HiOutlineUsers, label: 'Results' },
     { path: '/admin/analytics', icon: HiOutlineChartBarSquare, label: 'Analytics' },
]
